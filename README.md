...
One writer per worktree. A different model attacks meaningful diffs. “Done” is checked at the system of record. Handoffs carry receipts. Unattended agents file, don't fix. The loop matters more than the prompt.
