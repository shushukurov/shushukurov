...
Fintech founder. I push agents to their limits: pick a process, design the loop, close it end to end. The useful parts get published here.
...
Background: fraud and payments data science in London, then Chief Risk and Data Officer at [IMAN](https://imanum.app/en).
